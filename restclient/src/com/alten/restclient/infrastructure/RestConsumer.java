...
private static final String TAG = RestConsumer.class.getName();
    ...
    public static final String EXTRA_HTTP_VERB       = "com.alten.restclient.EXTRA_HTTP_VERB";
    public static final String EXTRA_PARAMS          = "com.alten.restclient.EXTRA_PARAMS";
    public static final String EXTRA_RESULT_RECEIVER = "com.alten.restclient.EXTRA_RESULT_RECEIVER";
    
    public static final String REST_RESULT = "com.alten.restclient.REST_RESULT";
                ...
                case POST: {
                    ...
                    if (params != null) 
                    {
                    	if (params.getString("JSONData") != null)
                    	{
                    		...
                    		StringEntity entity = new StringEntity(params.getString("JSONData"));
